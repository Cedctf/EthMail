...
// Get redirect URI
const REDIRECT_URI = clientEnv.GOOGLE_REDIRECT_URI || process.env.GOOGLE_REDIRECT_URI || 'http://localhost:3000/auth/callback';
...
export function getAuthUrl() {
  ...
  return `https://accounts.google.com/o/oauth2/v2/auth?client_id=${CLIENT_ID}&redirect_uri=${redirectUri}&response_type=code&scope=${scopesEncoded}&access_type=offline&prompt=consent`;
}
